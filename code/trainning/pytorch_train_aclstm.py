...
def train_one_iteraton(real_seq_np, model, optimizer, iteration, save_dance_folder, print_loss=False, save_bvh_motion=True):
    ...
    print(f'predict_groundtruth_seq shape: {predict_groundtruth_seq}')
...
# read_weight_path=""
# read_weight_path = "./train_weight_aclstm_martial/0001000.weight"
...
# for martial
write_weight_folder="./weights euler/"
write_bvh_motion_folder="./euler_train_tmp_bvh_aclstm_martial/"
