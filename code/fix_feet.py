...
bvh_file = './synthetic_motion/euler/out00.bvh'
train_data=read_bvh.get_training_data_euler_angles(bvh_file)
...
read_bvh.write_euler_traindata_to_bvh('xx_fixed.bvh', train_data)
